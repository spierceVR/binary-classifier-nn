...
impl MyNeuralNetwork {
    ...
    fn mse_loss(&self, y_actual: &Array1<f32>, y_pred: &Array1<f32>) -> f32 {
    ...
    fn partial_L_with_respect_to_yPred(&self, y_actual: f32, y_pred: f32) -> f32 {
        -2.0 * (y_actual - y_pred)
    }
    ...
    pub(crate) fn train(
        ...
        for epoch in 0..epochs {
            for (x, y_actual) in &data {
                ...
                let dL_dO = self.partial_L_with_respect_to_yPred(*y_actual, o1);
                ...
                let dO_dh1 = self.o.weights()[0] * deriv_sigmoid(sum_o1);
                let dh1_dw5 = h1;
                ...
                let dO_dh2 = self.o.weights()[1] * deriv_sigmoid(sum_o1);
                let dh2_dw6 = h2;
                ...
                let dO_db3 = deriv_sigmoid(sum_o1);
                ...
                *(self.h2.mut_weights()) = array![
                ...
                if x == &data[0].0 { // once per epoch
                    let loss = self.mse_loss(&array![*y_actual], &array![y_pred]);
